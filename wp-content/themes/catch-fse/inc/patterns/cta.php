...
<!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"foreground"} -->
<h2 class="has-text-align-center has-foreground-color has-text-color" style="font-style:normal;font-weight:400">' . esc_html__( 'Amazing Videos & Presentations', 'catch-fse' ) . '</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"body-text","fontSize":"normal"} -->
<p class="has-text-align-center has-body-text-color has-text-color has-normal-font-size">' . esc_html__( 'We Create, We Develop, We Inspire.', 'catch-fse' ) . '</p>
<!-- /wp:paragraph -->
