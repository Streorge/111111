...
class Product_Deals_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Deals Carousel', 'farmart' );
	}
	...
	protected function register_heading_settings_controls() {
		...
		$this->add_control(
			'countdown_icon',
			[
				'label'   => esc_html__( 'Countdown Icon', 'farmart' ),
				'type'    => Controls_Manager::ICONS,
				'default' => [],
			]
		);
	...
	protected function register_products_style_controls() {
		...
		$this->add_responsive_control(
			'hide_border_right',
			[
				'label'     => __( 'Border Right Content', 'farmart' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'farmart' ),
				'label_on'  => __( 'Show', 'farmart' ),
				'default'   => 'yes',
		...
		$this->add_responsive_control(
			'hide_border_hover',
			[
				'label'     => __( 'Hide Border Top in Hover', 'farmart' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'farmart' ),
				'label_on'  => __( 'Show', 'farmart' ),
				'default'   => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Space Around', 'farmart' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Items Padding', 'farmart' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
