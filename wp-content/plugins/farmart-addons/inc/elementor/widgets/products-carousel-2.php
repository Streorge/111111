...
class Products_Carousel_2 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Farmart - Products Carousel 2', 'farmart' );
	}
	...
	protected function _register_heading_settings_controls() {
		...
		$this->start_controls_tab( 'quick_links_tab', [ 'label' => esc_html__( 'Link All', 'farmart' ) ] );
	...
	protected function _register_products_settings_controls() {
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Thumbnail Space', 'farmart' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 100,
