...
class Custom_CSS extends Module {
	...
	public function register_controls( $element, $section_id ) {
		...
		$element->add_control(
			'custom_css_title',
			[
				'raw' => __( 'Add your own custom CSS here', 'farmart' ),
		...
		$element->add_control(
			...
			[
				'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'farmart' ),
				'type' => Controls_Manager::RAW_HTML,
