...
if( ! class_exists('Farmart_Widget_Brands_Nav') ) {
	...
	class Farmart_Widget_Brands_Nav extends WC_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display a list of brands to filter products in your store.', 'farmart' );
			$this->widget_id          = 'fm_product_brands';
			$this->widget_name        = esc_html__( 'Farmart - Filter Products by Brands', 'farmart' );
			parent::__construct();
		}
		...
		public function init_settings() {
			...
			$this->settings = array(
				'title'   => array(
					'type'  => 'text',
					'std'   => esc_html__( 'By Brands', 'farmart' ),
				...
				'display_type' => array(
					'type'    => 'select',
					'std'     => 'checkbox',
					'label'   => esc_html__( 'Display Type', 'farmart' ),
					'options' => array(
						'checkbox'       => esc_html__( 'Checkbox List', 'farmart' ),
						'vertical'       => esc_html__( 'Vertical List', 'farmart' ),
					),
				),
				'height'  => array(
					'type'  => 'text',
					'std'   => '130',
					'label' => esc_html__( 'Max height(px)', 'farmart' ),
				),
				'show_dropdown'                     => array(
					'type'  => 'checkbox',
					'std'   => 0,
