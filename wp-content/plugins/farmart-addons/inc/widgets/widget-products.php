...
if ( ! class_exists( 'Farmart_Widget_Products' ) ) {
	...
	class Farmart_Widget_Products extends WC_Widget {
		...
		public function __construct() {
			...
			$this->widget_name        = esc_html__( 'Farmart - Products', 'farmart' );
			$this->settings           = array(
				'title'    => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Products', 'farmart' ),
				...
				'taxonomy' => array(
					'type'    => 'select',
					'std'     => 'desc',
					'label'   => esc_html__( 'Condition', 'farmart' ),
					'options' => array(
						''         => esc_html__( 'Default', 'farmart' ),
						'category' => esc_html__( 'Same Current Category', 'farmart' ),
						'brand'    => esc_html__( 'Same Current Brand', 'farmart' ),
						'vendor'   => esc_html__( 'Same Current Vendor', 'farmart' ),
					),
				),
