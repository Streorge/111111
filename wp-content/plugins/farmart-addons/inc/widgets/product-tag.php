...
if( ! class_exists('Farmart_Widget_Product_Tag_Cloud') ) {
	...
	class Farmart_Widget_Product_Tag_Cloud extends WC_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Your most used product tags in cloud format.', 'farmart' );
			$this->widget_id          = 'farmart_product_tag_cloud';
			$this->widget_name        = esc_html__( 'Farmart - Filter Products by Tags', 'farmart' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Product Tags', 'farmart' ),
				...
				'hide_divider' => array(
					'type'  => 'checkbox',
					'std'   => 0,
					'label' => esc_html__( 'Hide divider', 'farmart' ),
				),
				'show_dropdown'                     => array(
					'type'  => 'checkbox',
					'std'   => 0,
