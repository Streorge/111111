	...
	class Farmart_Price_Filter_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$widget_ops  = array(
				...
				'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'farmart' ),
			);
			$control_ops = array( 'width' => 400, 'height' => 350 );
			parent::__construct( 'farmart-price-filter-list', esc_html__( 'Farmart - Price Filter List', 'farmart' ), $widget_ops, $control_ops );
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Content:', 'farmart' ); ?></label>
			...
			<p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'farmart' ); ?></p>
			<p><?php esc_html_e( '100|200', 'farmart' ); ?><br><?php esc_html_e( '200|300', 'farmart' ); ?>
				<br><?php esc_html_e( '300|400', 'farmart' ); ?></p>
			<?php
		}
	}
}