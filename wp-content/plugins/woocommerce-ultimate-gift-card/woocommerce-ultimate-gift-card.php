...
update_option('mwb_wgm_license_key' . $_SERVER['HTTP_HOST'], 'activated' );
update_option( 'mwb_wgm_license_hash' . $_SERVER['HTTP_HOST'], md5( $_SERVER['HTTP_HOST'] . 'WooCommerce Ultimate Gift Card' . 'activated' ) );
update_option( 'mwb_wgm_plugin_verified', '1' );
update_option( 'mwb_wgm_plugin_verified'.$_SERVER['HTTP_HOST'], '1' );
...
if ( $activated ) {
	...
	define( 'MWB_WGM_PLUGIN_VERSION', '2.7.8' );
