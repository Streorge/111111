			...
			<table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px; background-color:#0467A2;">
				...
				<tr>
					<td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height:18px; text-align: center; color: #888888;">
					  <p style="font-size: 18px; color: #575757; text-align: center; font-family: sans-serif;"><?php _e( 'Hello, This is the notification for your coupon amount.', 'woocommerce-ultimate-gift-card' ); ?><br/><?php _e( 'You have left with amount of ', 'woocommerce-ultimate-gift-card' ); ?>[COUPONAMOUNT]</p>
