			...
			<td class="forminp forminp-text">
				...
				<label for="mwb_wgm_thankyouorder_time">
					<select name="mwb_wgm_thankyouorder_time" class="mwb_wgm_new_woo_ver_style_select">
						...
						<option value="mwb_wgm_completed_status" <?php selected( $thankyouorder_time, 'mwb_wgm_completed_status' ); ?>><?php _e( 'Order is in Complete', 'woocommerce-ultimate-gift-card' ); ?></option>
					</select>
				</label>						
			</td>
		</tr>
