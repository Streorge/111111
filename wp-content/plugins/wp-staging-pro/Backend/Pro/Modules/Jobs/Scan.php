...
class Scan extends Job
{
    ...
    protected function buildDirectories()
    {
        ...
        if (!file_exists($wpcontentDir)) {
            wp_die(sprintf(
                __('<strong>Fatal error:</strong> Path <code>' . $wpcontentDir . '</code> does not exist!  <br><br> Did you move from one server to another recently or changed the location of your site? <br><br>
                ...
                <br>
                If you still need help, <a href="%s" target="_blank">please contact us!</a>
                ', 'wp-staging'),
