...
class Email_Footer extends Widget_Base {
	...
	protected function register_controls() {
		...
		$placeholders = [ '%%billing_first_name%%', '%%billing_last_name%%', '%%shipping_first_name%%', '%%shipping_last_name%%' ];
		$this->add_control(
			'important_note',
			[
		...
		$this->add_control(
			...
			[
				...
				'default'		=> __( 'Email Footer', 'woolementor-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' =>[
					'{{WRAPPER}} .wl-email-footer' => 'text-align: {{VALUE}};',
					'{{WRAPPER}} .wl-email-footer .wleh-content' => 'text-align: {{VALUE}};'
				],
				'toggle' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wl-email-footer h1' => 'margin: 0;',
					'{{WRAPPER}} .wl-email-footer h2' => 'margin: 0;',
					'{{WRAPPER}} .wl-email-footer h3' => 'margin: 0;',
					'{{WRAPPER}} .wl-email-footer h4' => 'margin: 0;',
					'{{WRAPPER}} .wl-email-footer h5' => 'margin: 0;',
					'{{WRAPPER}} .wl-email-footer h6' => 'margin: 0;',
				],
				'default' => 'traditional',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wl-email-footer' => 'color: {{VALUE}}',
					'{{WRAPPER}} .wl-email-footer .wlef-content' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' 	=> 'transparent',
				'selectors' => [
					'{{WRAPPER}} .wl-email-footer ' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' 	=> [
					'.wl {{WRAPPER}} .wl-email-footer' => 'font-size: {{SIZE}}{{UNIT}};',
					'.wl {{WRAPPER}} .wl-email-footer .wlef-content' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .wl-email-footer',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .wl-email-footer' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				// 'separator'		=> 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .wl-email-footer' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				// 'separator'		=> 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' 	=> [ 'px', '%', 'em' ],
				'selectors' 	=> [
					'{{WRAPPER}} .wl-email-footer' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$_footer 	= sanitize_text_field( $settings['email_footer_text'] );
		$_html_tag 	= sanitize_text_field( $settings['html_tag'] );
		$start_tag 	= !empty( $_html_tag ) ? "<{$_html_tag} class='wlef-content'>" : "";
		$end_tag 	= !empty( $_html_tag ) ? "</{$_html_tag}>" : "";
		$targets    = [ '%%billing_first_name%%', '%%billing_last_name%%', '%%shipping_first_name%%', '%%shipping_last_name%%' ];
		$replace 	= [ $order->get_billing_first_name(), $order->get_billing_last_name(), $order->get_shipping_first_name(), $order->get_shipping_last_name() ];
		$footer 	= str_replace( $targets, $replace, $_footer );
		
		echo "<div class='wl-email-footer'>". wp_kses_post( $start_tag ) .esc_html( $footer ) .wp_kses_post( $end_tag ) ."</div>";
	}
}