<?php
/**
 * Plugin Name: FS License Manager
...
class FS_WC_licenses_Manager
{
    ...
    public function __construct()
    {
		...
		update_option('fslm_lk', 'prowebber');
		update_option('fslm_ebun', 'raz0r');
        ...
        if ($this->is_active()) {
            ...
            add_action('woocommerce_order_status_changed', array($this, 'action_woocommerce_order_status_changed'), 1,
                3);
            ...
            add_action('woocommerce_order_details_after_order_table', array($this, 'fslm_order_item_meta_start'), 10,
                1);
            add_action('xlwcty_woocommerce_order_details_after_order_table', array($this, 'fslm_order_item_meta_start'),
                10, 1);
    ...
    public function add_plugin_actions()
    {
        ...
        if ((fslm_vendors_permission() || current_user_can('manage_options') || current_user_can('manage_woocommerce')) && $this->is_active()) {
            ...
            add_action('wp_ajax_nopriv_fslm_refresh_license_keys', array($this, 'fslm_refresh_license_keys_callback'));
            ...
            add_action('wp_ajax_nopriv_fslm_export_csv_lk_une_edit',
                array($this, 'fslm_export_csv_lk_une_edit_callback'));
            ...
            add_action('wp_ajax_nopriv_fslm_import_csv_lk_une_edit',
                array($this, 'fslm_import_csv_lk_une_edit_callback'));
    ...
    public function register_session()
    {
        ...
        if (!$this->is_active() || (isset($_SERVER['SERVER_NAME']) && $_SERVER['SERVER_NAME'] == FSLM_LOCAL_ENV) || $fslm_debug == 'on') {
    ...
    public function fslm_refresh_license_keys_callback()
    {
        ...
        $json = get_post_meta($order_id, 'fslm_json_license_details', true);
        ...
        if ($values) {
            ...
            if ($updated) {
                update_post_meta($order_id, 'fslm_json_license_details', json_encode($values));
            }
        }
    ...
    public function order_meta_boxe()
    {
        ...
        add_meta_box('fslm_order_actions', __('License Manager'), array($this, 'order_meta_box_content'), 'shop_order',
            'side', 'default');
    ...
    function send_mail($order_id)
    {
        ...
        $message = $this->apply_mail_text_filters(get_option('fslm_mail_message',
            __('<p>Dear [bfname] [blname]</p><p>Thank you for your order, those are your license keys for the order #[order_id]</p><p>you can see all your past orders and license keys <a title="My Account" href="[myaccount_url]">here</a>.</p>',
                'fslm')), $order_id);
    ...
    public function api_requests_handler_v2()
    {
        ...
        if (isset($_POST['fslm_v2_api_request'])) {
            ...
            if (isset($_POST['fslm_api_key']) && $_POST['fslm_api_key'] == get_option('fslm_api_key',
                ...
                if (($_POST['fslm_v2_api_request'] == 'activate') && (isset($_POST['fslm_v2_api_request']))) {
                    ...
                    if (($_POST['fslm_v2_api_request'] == 'deactivate') && (isset($_POST['license_key']))) {
                        ...
                        if (($_POST['fslm_v2_api_request'] == 'verify') && (isset($_POST['license_key']))) {

                            $device_id = isset($_POST['device_id']) ? $_POST['device_id'] : 'none';

                            $result = $this->license_verification_v2(esc_sql($_POST['license_key']),
                                esc_sql($device_id));

                            echo $result;
                        } else {
                            if (($_POST['fslm_v2_api_request'] == 'details') && (isset($_POST['license_key']))) {
                                $result = $this->license_details(esc_sql($_POST['license_key']));

                                echo $result;
                            } else {
                                if (($_POST['fslm_v2_api_request'] == 'extra_data') && (isset($_POST['product_id']))) {
                                    $result = $this->get_product_extra_data($_POST['product_id']);

                                    echo $result;
                                } else {
                                    if (($_POST['fslm_v2_api_request'] == 'license_status') && (isset($_POST['license_key']))) {
                ...
                if (get_option('fslm_enable_private_api', '') == 'on' &&
                    isset($_POST['fslm_private_api_key']) &&
                    $_POST['fslm_private_api_key'] == get_option('fslm_private_api_key',
                        '3a5088d8-2aa0-41d2-b151-79eaf845f3ef')) {

                    if (($_POST['fslm_v2_api_request'] == 'expire') && (isset($_POST['license_key']))) {

                        $result = $this->expire_license_v2(esc_sql($_POST['license_key']));
    ...
    function validate_cart_content()
    {
        ...
        foreach (WC()->cart->cart_contents as $cart_product) {
            ...
            if (($this->is_licensing_enabled($cart_product['product_id'],
