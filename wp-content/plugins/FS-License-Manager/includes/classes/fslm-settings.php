...
class FSLM_Settings
{
    ...
    function load_license_manager_admin_scripts()
    {
        ...
        wp_enqueue_style('fslm_License_Manager_Style', plugins_url('/assets/css/style.css', FSLM_PLUGIN_FILE), array(), '4400');
        ...
        if (isset($_GET['page'])
            ...
            && isset($_GET['tab'])
            && $_GET['tab'] == 'emails') { // too avoid conflict with other plugins that use TinyMCE
        ...
        wp_enqueue_script('fslm_select2_js', plugins_url('/assets/select2/js/select2.full.min.js', FSLM_PLUGIN_FILE),
            array('jquery'));


        wp_enqueue_script('fslm_Main', plugins_url('/assets/js/main.js', FSLM_PLUGIN_FILE), array('jquery', 'jquery-form'),
            '444');
